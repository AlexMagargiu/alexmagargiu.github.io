...
export default function About() {
    return (
        <section
            className="flex md:flex-row flex-col items-center justify-center gap-10 md:gap-36 bg-none-bg md:h-[calc(100vh-200px)] font-jetbrains text-primary-text"
            id="about"
        >
            <img
                src={webimg}
                className="rounded-[4rem] md:w-auto md:h-auto md:mt-0 mt-10 w-96 h-96 drop-shadow-[0_5px_10px_rgba(53,_162,_159,_0.7)]"
            ></img>
            <div className="flex flex-col md:items-start items-center justify-center gap-2">
                ...
                <p className="max-w-xl md:max-w-2xl mb-6 md:mb-0">
